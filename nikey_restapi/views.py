...
from nikey_restapi.serializers import NikeySerializer

@csrf_exempt
def address_list(request):
    if request.method == 'GET':
        query_set = Nikey_restApi.objects.all()
...
def address(request, pk):
    obj = Nikey_restApi.objects.get(pk=pk)
...
def login(request):
    if request.method == 'POST':
        ...
        obj = Nikey_restApi.objects.get(name=search_name)
